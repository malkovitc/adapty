...
const benefits: BenefitItem[] = [
  {
    ...
    description: 'Start with your existing design and iterate quickly. Run multiple variants simultaneously to find what converts best, with up to +20% revenue increase.',
    icon: <Zap className="w-6 h-6" />,
    imageSrc: '/images/paywall-builder/scale-paywalls.svg',
    imageAlt: 'A/B/C paywalls showing +20% revenue increase',
  },
  {
    id: 'realtime',
    title: 'Apply changes in real-time',
    description: 'Update paywalls instantly without app store reviews or new releases. Change buttons, text, and pricing live.',
    icon: <RefreshCw className="w-6 h-6" />,
    imageSrc: '/images/paywall-builder/realtime-changes.svg',
    imageAlt: 'Paywall buttons being edited in real-time',
  },
  {
    id: 'abtesting',
    title: 'Seamless integration with A/B testing',
    description: 'Run experiments to find the highest-converting paywall design with statistical confidence and predicted winner indicators.',
    icon: <FlaskConical className="w-6 h-6" />,
    imageSrc: '/images/paywall-builder/ab-testing.svg',
    imageAlt: 'A/B testing with predicted winner',
  },
  {
    id: 'structure',
    title: 'Deeply customizable paywall structure',
    description: 'Control every aspect of your paywall from layout to individual elements. Choose from multiple layout templates.',
    icon: <Settings className="w-6 h-6" />,
    imageSrc: '/images/paywall-builder/layouts.svg',
    imageAlt: 'Multiple paywall layout options',
  },
  {
    id: 'elements',
    title: 'Flexible adjustments for every element',
    description: 'Fine-tune colors, spacing, fonts, and positioning with precision controls in our visual UI builder.',
    icon: <Palette className="w-6 h-6" />,
    imageSrc: '/images/paywall-builder/ui-builder.svg',
    imageAlt: 'UI builder with element controls',
  },
  {
    id: 'localization',
    title: 'Convenient localization and personalization',
    description: 'Adapt your paywalls for different languages, regions, and user segments with easy locale management.',
    icon: <Globe className="w-6 h-6" />,
    imageSrc: '/images/paywall-builder/localization.svg',
    imageAlt: 'Paywalls in different locales',
  },
  {
    id: 'responsive',
    title: 'Responsive layout with multi-screen support',
    description: 'Paywalls look great on any device size, from phones to tablets. Preview all screen sizes instantly.',
    icon: <Smartphone className="w-6 h-6" />,
    imageSrc: '/images/paywall-builder/responsive.svg',
    imageAlt: 'Paywalls on different screen sizes',
  },
  {
    id: 'native',
    title: 'Truly native experience',
    description: 'Paywalls render natively for smooth performance and platform consistency. No webviews, no lag.',
    icon: <Target className="w-6 h-6" />,
    imageSrc: '/images/paywall-builder/native-ui.svg',
...
function StickyImage({ activeBenefit }: { activeBenefit: BenefitItem }) {
  const shouldReduceMotion = useReducedMotion();
      ...
      <Container>
        ...
        >
          ...
          <p className="text-lg text-slate-500 max-w-2xl mx-auto">
            Our paywall builder gives you complete control over your monetization experience
          </p>
        </motion.div>

        {/* Split Layout */}
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
          {/* Left Column - Scrollable Benefits (35%) */}
